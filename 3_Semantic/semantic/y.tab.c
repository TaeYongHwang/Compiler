...
{
       0,    44,    44,    48,    57,    60,    62,    66,    65,    74,
      73,    83,    86,    90,    97,   104,   103,   114,   115,   119,
     128,   130,   137,   136,   144,   150,   159,   161,   170,   172,
     174,   176,   178,   180,   183,   185,   187,   191,   198,   203,
     206,   210,   214,   217,   221,   220,   228,   232,   235,   237,
     239,   241,   243,   245,   248,   252,   255,   257,   260,   264,
     267,   269,   272,   274,   275,   276,   280,   279,   287,   290,
     292,   302
};
#endif
...
#line 106 "cminus.y" /* yacc.c:1646  */
    {(yyval) = (yyvsp[-6]);
						 ...
						 (yyval)->attr.name = funId;
						 (yyval)->lineno = funLine;
						 (yyval)->child[0] = (yyvsp[-2]);
